...
const EXCLUDED_CATS = new Set(["gratis", "destacado", "aire libre", "accesible", "infantil", "visitas guiadas", "danza", "circo", "ópera", "monólogos"]);
const CAT_PRIORITY = ["cine","deportes","ferias","conciertos","teatro","talleres","conferencias","literatura","musica","fotografia","exposiciones"];
